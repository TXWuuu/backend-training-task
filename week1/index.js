...
console.log(`[Q1] alexAge: ${alexAge}, alexMembershipID: ${alexMembershipID}, isRunningOnTreadmill: ${isRunningOnTreadmill}`);
...
const workoutGroupClassPrice = 500;
const workout1On1Price = 1500;
...
const AlexBudget = campaignBudget - (yogaGroupClassPrice*3 + workoutGroupClassPrice + workout1On1Price);
...
let waitingSeconds = 28 ;
let moveForward = false;

// 4-2. 目前一起等待的機車有 8 台
let waitMotocycleNum = 8;
...
const machineUsimgTime = 3;
const weekClass = 2;
const weekMachineUse = machineUsePrice * machineUsimgTime;
const weekGroupClass = groupClassPrice * weekClass;
totalBill += weekMachineUse + weekGroupClass;
...
a = 13; // 變數a重新賦予了一個 13 的數字型別
a = b + 4; // 取得變數b＝0，0+4的結果為4，將變數a重新賦予一個 4 的數字型別
a - b; //取得變數a＝4,b=0，執行4-0
b += 1; //取得變數b＝0，0+1得結果為1，將變數b重新賦予一個 1 的數字型別
//最終 a值為4，b值為1
...
//宣告一變數numberArr1，並賦予一數字型別陣列[5, 10, 15]
//宣告一變數numberArr2，指向numberArr1的記憶體空間[5, 10, 15]
//numberArr2 增加一陣列元素 [5, 10, 15, 20]
//賦予變數numberArr2一數字型別陣列[25, 30, 35]，並為一個新的記憶體空間
//numberArr1 值為[5, 10, 15, 20]，numberArr2 值為[25, 30, 35]
