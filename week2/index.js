...
// 請文字解釋為什麼
console.log(k * l > 21);
//k*l 會被轉為Number，3*8=24，24>21因此結果為true
...
let coachObject = {};
coachObject = performanceData.coaches[0];
if(coachObject.name === "Alice"){
  performanceData.coaches[0].performance += 50000-performanceData.coaches[0].performance;
}

coachObject = performanceData.coaches[1];
if(coachObject.name === "Bob"){
...
// 練習：計算小明今日消耗的卡路里
calorieBurn = 10 * activities.bicycle +
              30 * activities.running +
              40 * activities.yoga +
              10 * activities.bicycle;
